...
#             currency = order.session_id.currency_id
        ...
        if company_ids:
            domain.append(('company_id','in',company_ids.ids))
        if config_ids:
            session_ids = self.env['pos.session'].sudo().search([('config_id','in',config_ids.ids)])
...
#             currency = order.session_id.currency_id
    ...
    def _get_report_values(self, docids, data=None):
        ...
        data.update(self.get_sale_pos_details(data['date_start'], data['date_stop'], team_ids,company_ids,config_ids, data['state'] ))
        return data
